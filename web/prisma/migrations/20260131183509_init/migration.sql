...
CREATE TABLE "EmailAddresses" (
    ...
    CONSTRAINT "EmailAddresses_pkey" PRIMARY KEY ("id")
);
...
-- CreateIndex
CREATE UNIQUE INDEX "EmailAddresses_email_key" ON "EmailAddresses"("email");
...
-- AddForeignKey
ALTER TABLE "Emails" ADD CONSTRAINT "Emails_emailAddressId_fkey" FOREIGN KEY ("emailAddressId") REFERENCES "EmailAddresses"("id") ON DELETE CASCADE ON UPDATE CASCADE;
