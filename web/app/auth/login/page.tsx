      ...
      <div className="w-full max-w-md z-10">
        ...
        <div className="flex flex-col items-center justify-center mb-8 animate-fade-in">
          ...
          <p className="text-center text-muted-foreground text-sm flex items-center gap-2">
            ...
            Your inbox, infinitely organized
          </p>
        </div>
        ...
        <Card className="border-2 shadow-2xl backdrop-blur-sm bg-card/95 animate-slide-up">
          <CardHeader className="space-y-1 pb-4">
            ...
            <CardDescription className="text-center">
              Sign in to access your email management platform
            </CardDescription>
          </CardHeader>
          <CardContent className="pt-4">
            <Button
              variant="outline"
              size="lg"
              className="w-full h-12 text-base font-medium border-2 hover:bg-accent hover:border-primary/50 transition-all duration-300 hover:shadow-lg hover:scale-[1.02]"
              onClick={() => {
